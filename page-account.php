                        ...
                        <div class="basic-login">
                            <form role="form" method="post" action="updateAccount.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="reg_firstName" name="reg_firstName" type="text" placeholder="First Name" value = "<?php echo $firstname; ?>" required>
                                </div> 
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn pull-right" id="submitBtn" disabled>UPDATE</button>
